...
\name{Eoin}{Curtis}
\position{Full Stack developer{\enskip\cdotp\enskip}Data First}
\address{Dublin, Ireland}

\mobile{(+353) 083 066 8935}
\email{eoincur14@gmail.com}
\linkedin{eoin-curtis-6b2496330}{Eoin Curtis}
\github{Kertis4}
% \gitlab{gitlab-id}
